...
export const featuredProjects: FeaturedProject[] = [
  ...
  },
  {
    ...
    title: 'SafeGuard',
    description:
      'AI-powered financial resilience platform for first-time small business owners — conversational onboarding, a live dashboard, and insurance & compliance tracking.',
  ...
  },
  {
    ...
    title: 'RallyPoint',
    description:
      'Civic engagement platform helping underrepresented demographics discover and act on local campaigns and petitions — 12-model Prisma schema, Claude AI moderation pipeline.',
  ...
  },
  {
    ...
    title: 'HydraScan',
    description:
      'Native iOS recovery companion — live QuickPose movement capture paired with AI-driven recovery plans. Built with a hackathon team.',
